...
To build the final jar and optimize the rfidh2Mysql application for production, run:
...
Then navigate to [http://localhost:9192](http://localhost:9192) in your browser.
