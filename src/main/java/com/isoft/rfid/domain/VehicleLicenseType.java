...
public class VehicleLicenseType implements Serializable {
    ...
    public VehicleLicenseType updated(Instant updated) {
    ...
    public VehicleLicenseType active(Integer active) {
    ...
    public VehicleLicenseType gantryToll(Double gantryToll) {
    ...
    public boolean equals(Object o) {
        ...
        return id != null && id.equals(((VehicleLicenseType) o).id);
    }
