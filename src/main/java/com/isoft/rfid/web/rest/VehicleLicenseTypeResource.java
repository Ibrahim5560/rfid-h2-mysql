...
import com.isoft.rfid.service.VehicleLicenseTypeQueryService;
import com.isoft.rfid.service.VehicleLicenseTypeService;
...
/**
 * REST controller for managing {@link com.isoft.rfid.domain.VehicleLicenseType}.
 */
@RestController
@RequestMapping("/api")
public class VehicleLicenseTypeResource {
     ...
     */
    @PostMapping("/vehicle-license-types")
    public ResponseEntity<VehicleLicenseTypeDTO> createVehicleLicenseType(@Valid @RequestBody VehicleLicenseTypeDTO vehicleLicenseTypeDTO)
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PutMapping("/vehicle-license-types/{id}")
    public ResponseEntity<VehicleLicenseTypeDTO> updateVehicleLicenseType(
        @PathVariable(value = "id", required = false) final Long id,
        @Valid @RequestBody VehicleLicenseTypeDTO vehicleLicenseTypeDTO
    ) throws URISyntaxException {
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/vehicle-license-types/{id}", consumes = { "application/json", "application/merge-patch+json" })
    public ResponseEntity<VehicleLicenseTypeDTO> partialUpdateVehicleLicenseType(
        @PathVariable(value = "id", required = false) final Long id,
        @NotNull @RequestBody VehicleLicenseTypeDTO vehicleLicenseTypeDTO
    ) throws URISyntaxException {
     ...
     */
    @GetMapping("/vehicle-license-types")
     ...
     */
    @GetMapping("/vehicle-license-types/count")
     ...
     */
    @GetMapping("/vehicle-license-types/{id}")
    public ResponseEntity<VehicleLicenseTypeDTO> getVehicleLicenseType(@PathVariable Long id) {
     ...
     */
    @DeleteMapping("/vehicle-license-types/{id}")
    public ResponseEntity<Void> deleteVehicleLicenseType(@PathVariable Long id) {
