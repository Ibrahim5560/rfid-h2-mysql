...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PEAKHOURTARIFF_LIST actions', async () => {
    ...
    it('dispatches FETCH_PEAKHOURTARIFF actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PEAKHOURTARIFF actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PEAKHOURTARIFF actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PEAKHOURTARIFF actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PEAKHOURTARIFF actions', async () => {
      const expectedActions = [
        {
