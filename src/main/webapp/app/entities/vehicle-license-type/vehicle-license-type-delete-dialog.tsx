...
export const VehicleLicenseTypeDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="rfidh2MysqlApp.vehicleLicenseType.delete.question">
        <Translate contentKey="rfidh2MysqlApp.vehicleLicenseType.delete.question" interpolate={{ id: vehicleLicenseTypeEntity.id }}>
