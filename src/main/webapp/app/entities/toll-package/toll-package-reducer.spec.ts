...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TOLLPACKAGE_LIST actions', async () => {
    ...
    it('dispatches FETCH_TOLLPACKAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TOLLPACKAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TOLLPACKAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TOLLPACKAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TOLLPACKAGE actions', async () => {
      const expectedActions = [
        {
