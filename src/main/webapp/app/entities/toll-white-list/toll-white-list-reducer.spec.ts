...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TOLLWHITELIST_LIST actions', async () => {
    ...
    it('dispatches FETCH_TOLLWHITELIST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TOLLWHITELIST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TOLLWHITELIST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TOLLWHITELIST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TOLLWHITELIST actions', async () => {
      const expectedActions = [
        {
