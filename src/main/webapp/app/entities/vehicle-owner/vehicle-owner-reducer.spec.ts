...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VEHICLEOWNER_LIST actions', async () => {
    ...
    it('dispatches FETCH_VEHICLEOWNER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_VEHICLEOWNER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_VEHICLEOWNER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_VEHICLEOWNER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_VEHICLEOWNER actions', async () => {
      const expectedActions = [
        {
