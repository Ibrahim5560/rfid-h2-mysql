...
class VehicleOwnerResourceIT {
    ...
    private static final Double DEFAULT_WALLET = 1D;
    private static final Double UPDATED_WALLET = 2D;
    private static final Double SMALLER_WALLET = 1D - 1D;
    ...
    void createVehicleOwner() throws Exception {
        ...
        assertThat(testVehicleOwner.getWallet()).isEqualTo(DEFAULT_WALLET);
    }
    ...
    void getAllVehicleOwners() throws Exception {
        ...
        restVehicleOwnerMockMvc
            ...
            .andExpect(jsonPath("$.[*].wallet").value(hasItem(DEFAULT_WALLET.doubleValue())));
    }
    ...
    void getVehicleOwner() throws Exception {
        ...
        restVehicleOwnerMockMvc
            ...
            .andExpect(jsonPath("$.wallet").value(DEFAULT_WALLET.doubleValue()));
    }
    ...
    @Test
    @Transactional
    void getAllVehicleOwnersByWalletIsEqualToSomething() throws Exception {
        // Initialize the database
        vehicleOwnerRepository.saveAndFlush(vehicleOwner);

        // Get all the vehicleOwnerList where wallet equals to DEFAULT_WALLET
        defaultVehicleOwnerShouldBeFound("wallet.equals=" + DEFAULT_WALLET);

        // Get all the vehicleOwnerList where wallet equals to UPDATED_WALLET
        defaultVehicleOwnerShouldNotBeFound("wallet.equals=" + UPDATED_WALLET);
    }

    @Test
    @Transactional
    void getAllVehicleOwnersByWalletIsInShouldWork() throws Exception {
        // Initialize the database
        vehicleOwnerRepository.saveAndFlush(vehicleOwner);

        // Get all the vehicleOwnerList where wallet in DEFAULT_WALLET or UPDATED_WALLET
        defaultVehicleOwnerShouldBeFound("wallet.in=" + DEFAULT_WALLET + "," + UPDATED_WALLET);

        // Get all the vehicleOwnerList where wallet equals to UPDATED_WALLET
        defaultVehicleOwnerShouldNotBeFound("wallet.in=" + UPDATED_WALLET);
    }

    @Test
    @Transactional
    void getAllVehicleOwnersByWalletIsNullOrNotNull() throws Exception {
        // Initialize the database
        vehicleOwnerRepository.saveAndFlush(vehicleOwner);

        // Get all the vehicleOwnerList where wallet is not null
        defaultVehicleOwnerShouldBeFound("wallet.specified=true");

        // Get all the vehicleOwnerList where wallet is null
        defaultVehicleOwnerShouldNotBeFound("wallet.specified=false");
    }

    @Test
    @Transactional
    void getAllVehicleOwnersByWalletIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        vehicleOwnerRepository.saveAndFlush(vehicleOwner);

        // Get all the vehicleOwnerList where wallet is greater than or equal to DEFAULT_WALLET
        defaultVehicleOwnerShouldBeFound("wallet.greaterThanOrEqual=" + DEFAULT_WALLET);

        // Get all the vehicleOwnerList where wallet is greater than or equal to UPDATED_WALLET
        defaultVehicleOwnerShouldNotBeFound("wallet.greaterThanOrEqual=" + UPDATED_WALLET);
    }

    @Test
    @Transactional
    void getAllVehicleOwnersByWalletIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        vehicleOwnerRepository.saveAndFlush(vehicleOwner);

        // Get all the vehicleOwnerList where wallet is less than or equal to DEFAULT_WALLET
        defaultVehicleOwnerShouldBeFound("wallet.lessThanOrEqual=" + DEFAULT_WALLET);

        // Get all the vehicleOwnerList where wallet is less than or equal to SMALLER_WALLET
        defaultVehicleOwnerShouldNotBeFound("wallet.lessThanOrEqual=" + SMALLER_WALLET);
    }

    @Test
    @Transactional
    void getAllVehicleOwnersByWalletIsLessThanSomething() throws Exception {
        // Initialize the database
        vehicleOwnerRepository.saveAndFlush(vehicleOwner);

        // Get all the vehicleOwnerList where wallet is less than DEFAULT_WALLET
        defaultVehicleOwnerShouldNotBeFound("wallet.lessThan=" + DEFAULT_WALLET);

        // Get all the vehicleOwnerList where wallet is less than UPDATED_WALLET
        defaultVehicleOwnerShouldBeFound("wallet.lessThan=" + UPDATED_WALLET);
    }

    @Test
    @Transactional
    void getAllVehicleOwnersByWalletIsGreaterThanSomething() throws Exception {
        // Initialize the database
        vehicleOwnerRepository.saveAndFlush(vehicleOwner);

        // Get all the vehicleOwnerList where wallet is greater than DEFAULT_WALLET
        defaultVehicleOwnerShouldNotBeFound("wallet.greaterThan=" + DEFAULT_WALLET);

        // Get all the vehicleOwnerList where wallet is greater than SMALLER_WALLET
        defaultVehicleOwnerShouldBeFound("wallet.greaterThan=" + SMALLER_WALLET);
    }
    ...
    void putExistingVehicleOwner() throws Exception {
        ...
        assertThat(testVehicleOwner.getWallet()).isEqualTo(UPDATED_WALLET);
    }
