...
class VehicleResourceIT {
    ...
    void createVehicle() throws Exception {
        ...
        assertThat(testVehicle.getGantryToll()).isEqualTo(DEFAULT_GANTRY_TOLL);
    }
    ...
    @Test
    @Transactional
    void getAllVehiclesByGantryTollIsEqualToSomething() throws Exception {
        // Initialize the database
        vehicleRepository.saveAndFlush(vehicle);

        // Get all the vehicleList where gantryToll equals to DEFAULT_GANTRY_TOLL
        defaultVehicleShouldBeFound("gantryToll.equals=" + DEFAULT_GANTRY_TOLL);

        // Get all the vehicleList where gantryToll equals to UPDATED_GANTRY_TOLL
        defaultVehicleShouldNotBeFound("gantryToll.equals=" + UPDATED_GANTRY_TOLL);
    }

    @Test
    @Transactional
    void getAllVehiclesByGantryTollIsInShouldWork() throws Exception {
        // Initialize the database
        vehicleRepository.saveAndFlush(vehicle);

        // Get all the vehicleList where gantryToll in DEFAULT_GANTRY_TOLL or UPDATED_GANTRY_TOLL
        defaultVehicleShouldBeFound("gantryToll.in=" + DEFAULT_GANTRY_TOLL + "," + UPDATED_GANTRY_TOLL);

        // Get all the vehicleList where gantryToll equals to UPDATED_GANTRY_TOLL
        defaultVehicleShouldNotBeFound("gantryToll.in=" + UPDATED_GANTRY_TOLL);
    }

    @Test
    @Transactional
    void getAllVehiclesByGantryTollIsNullOrNotNull() throws Exception {
        // Initialize the database
        vehicleRepository.saveAndFlush(vehicle);

        // Get all the vehicleList where gantryToll is not null
        defaultVehicleShouldBeFound("gantryToll.specified=true");

        // Get all the vehicleList where gantryToll is null
        defaultVehicleShouldNotBeFound("gantryToll.specified=false");
    }

    @Test
    @Transactional
    void getAllVehiclesByGantryTollIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        vehicleRepository.saveAndFlush(vehicle);

        // Get all the vehicleList where gantryToll is greater than or equal to DEFAULT_GANTRY_TOLL
        defaultVehicleShouldBeFound("gantryToll.greaterThanOrEqual=" + DEFAULT_GANTRY_TOLL);

        // Get all the vehicleList where gantryToll is greater than or equal to UPDATED_GANTRY_TOLL
        defaultVehicleShouldNotBeFound("gantryToll.greaterThanOrEqual=" + UPDATED_GANTRY_TOLL);
    }

    @Test
    @Transactional
    void getAllVehiclesByGantryTollIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        vehicleRepository.saveAndFlush(vehicle);

        // Get all the vehicleList where gantryToll is less than or equal to DEFAULT_GANTRY_TOLL
        defaultVehicleShouldBeFound("gantryToll.lessThanOrEqual=" + DEFAULT_GANTRY_TOLL);

        // Get all the vehicleList where gantryToll is less than or equal to SMALLER_GANTRY_TOLL
        defaultVehicleShouldNotBeFound("gantryToll.lessThanOrEqual=" + SMALLER_GANTRY_TOLL);
    }

    @Test
    @Transactional
    void getAllVehiclesByGantryTollIsLessThanSomething() throws Exception {
        // Initialize the database
        vehicleRepository.saveAndFlush(vehicle);

        // Get all the vehicleList where gantryToll is less than DEFAULT_GANTRY_TOLL
        defaultVehicleShouldNotBeFound("gantryToll.lessThan=" + DEFAULT_GANTRY_TOLL);

        // Get all the vehicleList where gantryToll is less than UPDATED_GANTRY_TOLL
        defaultVehicleShouldBeFound("gantryToll.lessThan=" + UPDATED_GANTRY_TOLL);
    }

    @Test
    @Transactional
    void getAllVehiclesByGantryTollIsGreaterThanSomething() throws Exception {
        // Initialize the database
        vehicleRepository.saveAndFlush(vehicle);

        // Get all the vehicleList where gantryToll is greater than DEFAULT_GANTRY_TOLL
        defaultVehicleShouldNotBeFound("gantryToll.greaterThan=" + DEFAULT_GANTRY_TOLL);

        // Get all the vehicleList where gantryToll is greater than SMALLER_GANTRY_TOLL
        defaultVehicleShouldBeFound("gantryToll.greaterThan=" + SMALLER_GANTRY_TOLL);
    }
    ...
    void putExistingVehicle() throws Exception {
        ...
        assertThat(testVehicle.getGantryToll()).isEqualTo(UPDATED_GANTRY_TOLL);
    }
