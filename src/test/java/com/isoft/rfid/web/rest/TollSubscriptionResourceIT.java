...
class TollSubscriptionResourceIT {
    ...
    private static final Instant DEFAULT_DATE_TIME_TO = Instant.ofEpochMilli(0L);
    private static final Instant UPDATED_DATE_TIME_TO = Instant.now().truncatedTo(ChronoUnit.MILLIS);
    ...
    public static TollSubscription createEntity(EntityManager em) {
        TollSubscription tollSubscription = new TollSubscription()
            ...
            .dateTimeTo(DEFAULT_DATE_TIME_TO)
    ...
    public static TollSubscription createUpdatedEntity(EntityManager em) {
        TollSubscription tollSubscription = new TollSubscription()
            ...
            .dateTimeTo(UPDATED_DATE_TIME_TO)
    ...
    void createTollSubscription() throws Exception {
        ...
        assertThat(testTollSubscription.getDateTimeTo()).isEqualTo(DEFAULT_DATE_TIME_TO);
    ...
    @Test
    @Transactional
    void checkDateTimeToIsRequired() throws Exception {
        int databaseSizeBeforeTest = tollSubscriptionRepository.findAll().size();
        // set the field null
        tollSubscription.setDateTimeTo(null);
    ...
    void getAllTollSubscriptions() throws Exception {
        ...
        restTollSubscriptionMockMvc
            ...
            .andExpect(jsonPath("$.[*].dateTimeTo").value(hasItem(DEFAULT_DATE_TIME_TO.toString())))
    ...
    void getTollSubscription() throws Exception {
        ...
        restTollSubscriptionMockMvc
            ...
            .andExpect(jsonPath("$.dateTimeTo").value(DEFAULT_DATE_TIME_TO.toString()))
    ...
    @Test
    @Transactional
    void getAllTollSubscriptionsByDateTimeToIsEqualToSomething() throws Exception {
        // Initialize the database
        tollSubscriptionRepository.saveAndFlush(tollSubscription);

        // Get all the tollSubscriptionList where dateTimeTo equals to DEFAULT_DATE_TIME_TO
        defaultTollSubscriptionShouldBeFound("dateTimeTo.equals=" + DEFAULT_DATE_TIME_TO);

        // Get all the tollSubscriptionList where dateTimeTo equals to UPDATED_DATE_TIME_TO
        defaultTollSubscriptionShouldNotBeFound("dateTimeTo.equals=" + UPDATED_DATE_TIME_TO);
    }

    @Test
    @Transactional
    void getAllTollSubscriptionsByDateTimeToIsInShouldWork() throws Exception {
        // Initialize the database
        tollSubscriptionRepository.saveAndFlush(tollSubscription);

        // Get all the tollSubscriptionList where dateTimeTo in DEFAULT_DATE_TIME_TO or UPDATED_DATE_TIME_TO
        defaultTollSubscriptionShouldBeFound("dateTimeTo.in=" + DEFAULT_DATE_TIME_TO + "," + UPDATED_DATE_TIME_TO);

        // Get all the tollSubscriptionList where dateTimeTo equals to UPDATED_DATE_TIME_TO
        defaultTollSubscriptionShouldNotBeFound("dateTimeTo.in=" + UPDATED_DATE_TIME_TO);
    }

    @Test
    @Transactional
    void getAllTollSubscriptionsByDateTimeToIsNullOrNotNull() throws Exception {
        // Initialize the database
        tollSubscriptionRepository.saveAndFlush(tollSubscription);

        // Get all the tollSubscriptionList where dateTimeTo is not null
        defaultTollSubscriptionShouldBeFound("dateTimeTo.specified=true");

        // Get all the tollSubscriptionList where dateTimeTo is null
        defaultTollSubscriptionShouldNotBeFound("dateTimeTo.specified=false");
    }
    ...
    void getAllTollSubscriptionsByTollPackageIsEqualToSomething() throws Exception {
        ...
        em.flush();
        tollSubscription.addTollPackage(tollPackage);
        tollSubscriptionRepository.saveAndFlush(tollSubscription);
    ...
    void putExistingTollSubscription() throws Exception {
        ...
        assertThat(testTollSubscription.getDateTimeTo()).isEqualTo(UPDATED_DATE_TIME_TO);
    ...
    void partialUpdateTollSubscriptionWithPatch() throws Exception {
        ...
        partialUpdatedTollSubscription.dateTimeFrom(UPDATED_DATE_TIME_FROM).vehicleOwner(UPDATED_VEHICLE_OWNER);
